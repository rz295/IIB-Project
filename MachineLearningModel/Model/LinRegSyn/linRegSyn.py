...
li2, rawADC, testTemp, trueTemp, Pi_1t, Pi_2t, Pi_3t, Pi_4t = ([] for i in range(8))
...
dx.to_csv("/Users/raezhao/Desktop/IIB-Project/MachineLearningModel/Results/LinRegSyn22/TestValues.csv")
dy = pd.DataFrame(trueTemp, columns= None)
dy.to_csv("/Users/raezhao/Desktop/IIB-Project/MachineLearningModel/Results/LinRegSyn22/TrueValues.csv")
dz = pd.DataFrame(rawADC, columns= None)
dz.to_csv("/Users/raezhao/Desktop/IIB-Project/MachineLearningModel/Results/LinRegSyn22/rawADC.csv")