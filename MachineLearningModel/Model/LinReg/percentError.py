...
predictedData = pd.read_csv("/Users/raezhao/Desktop/IIB-Project/MachineLearningModel/Results/LinReg/TestValues.csv") 
trueData = pd.read_csv("/Users/raezhao/Desktop/IIB-Project/MachineLearningModel/Results/LinReg/TrueValues.csv") 
rawADC = pd.read_csv("/Users/raezhao/Desktop/IIB-Project/MachineLearningModel/Results/LinReg/rawADC.csv") 
errorPer = []

for i in range(0, 45000):
    error = (trueData['0'][i] - predictedData['0'][i]) / trueData['0'][i] * 100
